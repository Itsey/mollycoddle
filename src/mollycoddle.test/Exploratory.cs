    ...
    public class Exploratory {
        ...
        public static IEnumerable<object[]> MustNotMatchDataMethod() {
            ...
            var mnmTestData = new List<Tuple<string, string, bool>>() {
                new Tuple<string, string, bool>($"blinky{Environment.NewLine}blonky{Environment.NewLine}blank",
                    "blonky", true)
            };
        ...
        public static IEnumerable<object[]> StartStopRegex_DataMethod() {
            ...
            startTestNullEndTest.Add(new StartStopTestData() {
                StartString = "money", StopString = null, TestList = startTestNullEnd
            });
            ...
            startEndNullTest.Add(new StartStopTestData() {
                StartString = null, StopString = null, TestList = startEndNullTestStrings
            });
            ...
            startNullTest.Add(new StartStopTestData() {
                StartString = null, StopString = "four", TestList = startNullTestStrings
            });
        ...
        [InlineData("/primaryfiles", "/primaryfiles/default/subfolder/test.txt", "default", "subfolder/test.txt")]
        [InlineData("/primaryfiles", "/primaryfiles/default/", "default", "")]
        [InlineData("/primaryfiles", "primaryfiles/default/sub/nested.txt", "default", "sub/nested.txt")]
        [InlineData("/molly", "molly/default/defaultrules.mollyset", "default", "defaultrules.mollyset")]
        public void ConvertDownloadPathToLocalPath(string molsbaseMarker, string downloadUrl, string versionMarker,
            string fileName) {
        ...
        public void MustNotMatch_CausesViolaton_OnMatch(Tuple<string, string, bool> data) {
            ...
            mps.WithRootedFile("src\\filename.sln",
                data.Item1); // $"blinky{Environment.NewLine}blonky{Environment.NewLine}blank");
        ...
        public void Split_into_chunks_simple_works2() {
            ...
            var chunks =
                sut.GetChunks("[U::a[P::b[R::plisky[G::/primaryfiles/default[L::http://somenexusserver/repository/",
                    markers);
        ...
        public void Split_into_chunks_with_null_works() {
            var sut = new NexusSupport(mo);
            var chunks = sut.GetChunks("[aone[btwo[cthree", new string[] {
                "[a", "[x", "[c"
            });
        ...
        public void TestMinmatchExpressions(string filename, string pattern, bool matchExpected) {
            ...
            var mm = new Minimatcher(pattern, new Options() {
